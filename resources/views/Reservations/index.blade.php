                        ...
                        <div class="col-dm-4 col-reservation" >
                            <div class="card reservation" style="min-width: 18rem; max-width: 18rem;">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item"><i class="fas fa-birthday-cake"></i>&nbsp;{{ $reservation->reservationDate }}</li>
                                    <li class="list-group-item"><i class="fas fa-phone"></i>&nbsp;{{ $reservation->reservationHour }}</li>
                                    ...
                                    <li class="list-group-item"><i class="fas fa-paper-plane"></i>&nbsp;{{ $reservation->childrenQuantity }}</li>
